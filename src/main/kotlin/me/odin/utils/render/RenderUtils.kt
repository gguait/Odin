...
object RenderUtils {
    ...
    fun renderVec(entity: Entity): Vec3 =
        Vec3(
            renderX(entity),
            renderY(entity),
            renderZ(entity)
    ...
    fun renderX(entity: Entity): Double =
        entity.lastTickPosX + (entity.posX - entity.lastTickPosX) * partialTicks

    fun renderY(entity: Entity): Double =
        entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * partialTicks

    fun renderZ(entity: Entity): Double =
    ...
    fun renderCustomBeacon(title: String, x: Double, y: Double, z: Double, r: Int, g: Int, b: Int, partialTicks: Float) {
        val dist = mc.thePlayer.getDistance(x, y, z).toFloat()
        drawCustomEspBox(
            floor(x), 1.0,
            floor(y), 1.0,
            floor(z), 1.0,
    ...
    fun renderBoxText(title: String, x: Double, y: Double, z: Double, r: Int, g: Int, b: Int) {
        val dist = mc.thePlayer.getDistance(x, y, z)
        drawCustomEspBox(
            floor(x), 1.0,
            floor(y), 1.0,
            floor(z), 1.0,
    ...
    fun renderBeaconBeam(x: Double, y: Double, z: Double, r: Float, g: Float, b: Float, a: Float, depthCheck: Boolean, partialTicks: Float) {
        val height = 300
        val bottomOffset = 0
    ...
    fun drawModel(x: Int, y: Int, width: Int, height: Int) {
